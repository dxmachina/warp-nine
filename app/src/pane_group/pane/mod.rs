...
impl PaneId {
    ...
    // LOCAL FORK: fn from_code_diff_pane_ctx removed with the agent.
    ...
    // LOCAL FORK: fn from_ai_fact_pane_ctx removed with the agent.
    // LOCAL FORK: fn from_ai_document_pane_ctx removed with the agent.
    // LOCAL FORK: fn from_custom_router_editor_pane_ctx removed with the agent.
    // LOCAL FORK: fn from_execution_profile_editor_pane_ctx removed with the agent.
    ...
    // LOCAL FORK: fn from_code_diff_pane_view removed with the agent.
    ...
    // LOCAL FORK: fn from_ai_fact_pane_view removed with the agent.
    // LOCAL FORK: fn from_ai_document_pane_view removed with the agent.
    // LOCAL FORK: fn from_custom_router_editor_pane_view removed with the agent.
    // LOCAL FORK: fn from_execution_profile_editor_pane_view removed with the agent.
