...
// LOCAL FORK: `test_create_folder_from_command_palette` went with the Warp Drive browser. The
// "Create a New Personal/Team Folder" palette actions it drove were removed with the panel's
// naming dialog.
