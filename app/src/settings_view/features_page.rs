...
// LOCAL FORK: impl FeaturesPageAction::telemetry_event was a 469-line pure mapping
// from each settings toggle to a FeaturesPageAction telemetry event. It went with
// telemetry; it read settings but changed nothing.
