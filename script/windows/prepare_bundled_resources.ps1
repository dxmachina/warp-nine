...
$AdditionalLicenses = @(
    ...
    # pipeline, matching `script/prepare_bundled_resources`. Its licence file was
    # deleted along with the vendored code it covered.
