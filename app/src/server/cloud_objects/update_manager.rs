...
impl UpdateManager {
    ...
    // LOCAL FORK: `update_object_online` went with cloud sync. It pushed an object update
    // straight to the server outside the sync queue. Its last caller went with the
    // online-only move operations.
