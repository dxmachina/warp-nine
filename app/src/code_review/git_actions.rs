...
//! the end-to-end actions a button triggers.
...
/// Creates a PR for `branch` with `gh pr create --fill`. Title/body were
/// generated by the agent; without it `--fill` is the only source.
