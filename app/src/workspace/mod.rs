...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        .with_context_predicate(id!("Workspace") & id!("WarpDrive_BelongsToTeam") & id!("IsOnline"))
        ...
        .with_context_predicate(id!("Workspace") & id!("IsOnline") & id!("WarpDrive_BelongsToTeam"))
        ...
        .with_context_predicate(id!("Workspace")),
        // LOCAL FORK: the folder-creation bindings went with the Warp Drive browser; a folder
        // has no UI to appear in and the naming dialog they opened lived in the panel.
        EditableBinding::new(
        ...
        // LOCAL FORK: the `workspace:toggle_warp_drive` and `workspace:left_panel_warp_drive`
        // bindings went with the Warp Drive browser.
        EditableBinding::new(
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About WarpNine"),
            WorkspaceAction::ShowSettingsPage(SettingsSection::About),
        )
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace"))
        .with_custom_action(CustomAction::ShowAboutWarp),
        // LOCAL FORK: the "Open Settings: Teams" binding went with the Teams settings page.
        EditableBinding::new(
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // LOCAL FORK: the "Open Settings: Billing and usage" binding went with the
        // Billing and usage settings page.
        EditableBinding::new(
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // LOCAL FORK: the "Open Settings: Environments" binding went with the cloud
