        ...
        while let Some((visible_idx, block_entry)) = items_iter.next() {
            ...
            match block_entry {
                VisibleItem::Block {
                    ...
                    // LOCAL FORK: a block could also be highlighted because another
                    // shared-session participant had selected it, which drew their colour
                    // as a border plus their avatar in the block's top right.
                ...
                VisibleItem::Banner {
                    ...
                    // LOCAL FORK: the only banner that suppressed this border was the
                    // shared-session start/end banner, which drew its own.
                    draw_border_above_block = true;
