...
// LOCAL FORK: `assert_warp_drive_is_open` / `assert_warp_drive_is_closed` went with the Warp
// Drive browser, along with the `test_create_folder_from_command_palette` test that used them.
