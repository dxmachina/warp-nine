...
pub enum FeatureFlag {
    ...
    // LOCAL FORK: `CreatingSharedSessions`, `ViewingSharedSessions`,
    // `SharedSessionWriteToLongRunningCommands`, `SessionSharingAcls` and
    // `AgentSharedSessions` all went with session sharing.
